	...
	For he = 0 To he_max Step he_step
		...
		Else
			If ConfigAmbig <> 0 Then
				...
				Else
					inverse_problem_v1_ambig_storm(h, z, Config_step_h_1, Config_step_te_1, Config_step_ti_1, he)
				EndIf
			Else
		...
		Else
			If ConfigAmbig <> 0 Then
				...
				Else
					inverse_problem_v2_ambig_storm(h, z, Config_step_h_2, Config_step_te_2, Config_step_ti_2, he)
				EndIf
			Else
