...
echo U_UPRISE_short.bas
fbc -s console -t 10000 -fpu sse  -arch 686 U_UPRISE_short.bas

echo U_UPRISE_qTrap.bas
fbc -s console -t 10000 -fpu sse  -arch 686 U_UPRISE_qTrap.bas
...
copy U_UPRISE_short.exe UPRISE
copy U_UPRISE_qTrap.exe UPRISE
